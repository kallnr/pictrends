    ...
    <nav class="bg-white bg-opacity-50 fixed w-full top-0 z-20 dark:bg-slate-800">
        <div class="hidden lg:block">
            <div class="  flex items-center mx-auto py-7 max-w-screen-lg justify-between">
                <div>
                    <h2 class="text-[20px] font-poppins dark:text-white font-medium">Snapdrow</h2>
                </div>
                <div class="mt-2 flex items-center">
                    <button
                        class="text-white px-5 bg-slate-800 rounded-md mr-4 py-1 transition duration-500 ease-in-out hover:scale-105">
                        <a href="login">Log in</a>
                    </button>
                    <button
                        class=" bg-putih border border-1 py-1 px-5 rounded-md transition duration-500 ease-in-out hover:scale-105"><a
        ...
        <div class="flex justify-between py-5 px-5 mx-auto lg:hidden">
            <div class="">
                <h2 class=" font-poppins text-[20px] font-medium">Snapdrow</h2>
            </div>
            <div class=" ">
                <button
                    class=" w-[70px] h-[30px] text-[14px] text-white px-2 bg-slate-800 rounded-md mr-2 py-1  transition duration-500 ease-in-out hover:scale-105">
                    <a href="login">Login</a>
                </button>
                <button
                    class=" w-[85px] h-[30px] text-[14px]  bg-putih border border-1 py-1 px-2 rounded-md transition duration-500 ease-in-out hover:scale-105 ">
        ...
        <div class="flex max-w-screen-lg mx-auto flex-wrap">
            <div class="w-1/2 hidden lg:block">
                <div class="flex flex-col">
                    ...
                    <div>
                        <h2 class="text-[44px] font-poppins font-medium">Explore the <span class="text-utama">World's
                            </span> <br>
                            Latest <span class="text-utama">Snapdrow </span></h2>
                    </div>
                    <div>
            ...
            <div class=" mx-auto px-5 lg:hidden">
                ...
                <div class="mt-[-280px] z-20 fixed ml-[70px] ">
                    <div
                        class="w-[115px] h-[20px] mx-2 mt-[80px] mb-3 py-1 text-center  bg-white shadow-xl rounded-full text-primary text-[10px]">
                        <b>Explore The World ! </b>
                    </div>
                </div>
                <div class="flex flex-col mx-auto text-center mt-5">
                    <div>
                        <h2 class="text-[20px] font-poppins font-medium  ">Change your picture,<br>
                            change your story</h2>
                    </div>
                    <div>
                        <p class="font-poppins text-[10px] text-slate-700  mt-4">The extraordinary picture k<br>
                            deserves an extraordinary presentation!</p>
                    </div>
                    <div class="mt-4">
                        <button class="bg-slate-800 rounded-full w-[70px] h-[30px] text-[14px] py-1 text-white"><a
