<div>
    ...
    @if (session['success'])
    <div class="p-3 bg-green-600 text-putih">
        <div class="container">
    ...
    <section
        ...
        <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
            <footer class="flex justify-between items-center ">
                <div class="flex items-center">
                    <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img
                            ...
                            src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Michael Gough">Kamal
                    </p>
                    <small class="text-[10px] font-light text-gray-600 dark:text-gray-400"></small>
                </div>
            ...
            <p class="ms-8 text-gray-500 dark:text-gray-400 text-[14px] font-normal">Hallo</p>
        </article>
        {{-- @empty --}}
    ...
    <div class="flex gap-2 mt-2 ml-6 mb-2">
        <div class="w-3/4">
            ...
            <input wire:model="isi_komentar" type="text"
