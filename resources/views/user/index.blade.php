...
@section('content')
                                    ...
                                    <div class="flex flex-col">
                                        <div class="mt-2">
                                            ...
                                            <div class="flex items-center mt-3 ml-1">
                                                ...
                                                <small class="ml-3 text-[14px] ">{{$dataprofile->alamat}}</small>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <div>
    ...
    <section class=" lg:hidden mx-auto mt-[50px]">
        ...
        <div class="mb-4  border-gray-200 dark:border-gray-700 mx-4 -sm:pl-[40px]">
            <ul class="flex flex-wrap  text-sm font-medium text-center justify-around lg:justify-normal md:justify-normal sm:pl-[260px] sm:justify-normal"
                id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                <li class="" role="presentation">
    ...
    <div id="default-tab-content">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div x-show="open" @click.outside=" open = false "
                                ...
                                <ul class="py-2" aria-labelledby="dropdownButton">
                                    ...
                                    <li>
                                        <form action="/post/{{ $ft->id }}" method="POST">
                                            @method('delete')
                                            @csrf
                                            <button type="submit"
        ...
        <div class="hidden p-4 rounded-lg mb-14" id="album" role="tabpanel" aria-labelledby="album-tab">
            <div class="max-w-screen-md flex justify-start items-center mx-auto mb-3">
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button"
                    class="flex justify-center bg-utama items-center w-9 h-9 rounded-md border-1 border-slate-500"><i
                        class="text-putih bi bi-plus"style="font-size: 24px;"></i></button>
            </div>
            <!--Modal-->
            <div id="crud-modal" open=false" tabindex="-1" aria-hidden="true"
                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <!-- Modal content -->
                    <div class="relative bg-putih rounded-lg shadow dark:bg-gray-700">
